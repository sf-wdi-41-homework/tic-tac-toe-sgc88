...
$(document).ready(function() {
  ...
  $('.box').on('click', function() {
    if ($(this).text() === '' && win === false) {
      ...
      // TODO: This is a lot of logic!  I'd like to challenge you to turn this into a function that you call instead.  Also consider passing in an 'X' or an 'O' into this function so that you can reduce your code in half by reusing the logic or each player.  Also let the player know which person won, X or O.
      if (
        ($('.1').text() === 'O' &&
          $('.2').text() === 'O' &&
          $('.3').text() === 'O') ||
